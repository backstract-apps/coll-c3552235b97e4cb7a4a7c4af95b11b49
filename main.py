...
app = FastAPI(title='Backstract Generated APIs - coll-c3552235b97e4cb7a4a7c4af95b11b49', debug=False,
              docs_url='/upbeat-lakshmi-be3ff60c420711f09b2b56996692f0be37/docs',
              openapi_url='/upbeat-lakshmi-be3ff60c420711f09b2b56996692f0be37/openapi.json')
...
app.include_router(
    router,
    prefix='/upbeat-lakshmi-be3ff60c420711f09b2b56996692f0be37/api',
    tags=['APIs v1']
)
